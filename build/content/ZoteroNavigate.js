    ...
    function ZoteroNavigate(){
        ...
        this.handleKeyup = function(event){
            if (event.altKey && event.code === 'ArrowLeft'){
                ...
                this.backward();
                if (this.currentItem() != null){
                    const [item, collection] = this.currentItem();
        ...
        this.setHandlers = function(doc){
            doc.addEventListener('select', this.handleSelect);
            doc.addEventListener('keyup', this.handleKeyup);
        }
        
    }
    
    Zotero.zoteronavigate = new ZoteroNavigate()
